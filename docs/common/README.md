...
These are cross-cutting concerns used across the application.

## Contents

- [**PAGINATION** - Page/limit convention and response format](/docs/common/PAGINATION)
- [**REQUEST_STRUCTURE** - Auth by cookie, guards, public vs protected endpoints](/docs/common/REQUEST_STRUCTURE)
