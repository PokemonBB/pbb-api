...
Conceptual documentation for all systems in the application.  
Use the folder structure to navigate.  

All the technical documentation of the api is available at:  
...
- [**FRIENDS** - Friends and friend requests](/docs/friends)
- [**NOTIFICATIONS** - In-app notifications](/docs/notifications)
- [**AUDIT** - Audit logs and who can access them](/docs/audit)
- [**DATABASE** - Collections and schemas](/docs/database)
- [**API_DOCS** - Documentation system and Docs API](/docs/api-docs)
